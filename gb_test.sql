...
--
-- Хост: localhost:8889
-- Время создания: Дек 17 2020 г., 16:28
...
INSERT INTO `basket` (`id_basket`, `id_good`, `good_count`, `id_user`) VALUES
(7, 1, 23, '4hr9e33t63tgt15ts5e13f8612123123'),
(9, 1, 5, '4hr9e33t63tgt15ts5e13f8612'),
(13, 3, 6, '4hr9e33t63tgt15ts5e13f8612'),
(14, 2, 6, '4hr9e33t63tgt15ts5e13f8612');
...
--
ALTER TABLE `basket`
  MODIFY `id_basket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
